...
def ResNet(stack_fn,
    ...
    if preact is True:
        C5 = layers.BatchNormalization(axis=bn_axis, epsilon=1.001e-5,
                                      name='post_bn')(C5)
        C5 = layers.Activation('relu', name='post_relu')(C5)
    ...
    # Create model.
    model = models.Model(inputs, [C2,C3,C4,C5], name=model_name)
